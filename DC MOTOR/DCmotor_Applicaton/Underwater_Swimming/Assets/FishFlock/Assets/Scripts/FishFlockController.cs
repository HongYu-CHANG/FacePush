...
namespace FishFlock
{
    public class FishFlockController : MonoBehaviour
    {
        ...
        [Tooltip("Minimum acceleration to be applied on the fish vector."), Range(0.1f, 50)]
        ...
        [Tooltip("Minimum speed to be applied on the fish direction vector."), Range(0.4f, 30)]
        public float minSpeed = 0.1f;
        [Tooltip("Maximum speed to be applied on the fish direction vector."), Range(0.7f, 30)]
        public float maxSpeed = 1.0f;
        [Tooltip("Minimum force to be applied on the fish direction vector."), Range(0.01f, 10)]
        public float minForce = 0.01f;
        [Tooltip("Maximum force to be applied on the fish direction vector."), Range(0.07f, 10)]
        ...
        [Tooltip("Minimum turn speed when rotating the fish to it's direction vector."), Range(0.1f, 10)]
        public float minTurnSpeed = 5;
        [Tooltip("Maximum turn speed when rotating the fish to it's direction vector."), Range(0.1f, 10)]
